...
export const projects: Project[] = [
  ...
  },
  {
    ...
    eyebrow: 'Responsive redesign',
    year: '2024',
    categories: ['Responsive Web Design', 'Interaction Design', 'Front-end Implementation'],
    summary: 'An outdated furniture shopping experience redesigned as a modern responsive digital storefront.',
    heroStatement: 'Redesigning an outdated furniture shopping experience into a modern responsive digital storefront.',
    heroAlt: 'Modern responsive furniture ecommerce website redesign with desktop and mobile interfaces',
    color: '#4F8CFF',
    overview: 'My Furniture Store reworks a cluttered shopping journey into a calm, image-led storefront. The design balances browsing inspiration with the practical product information people need to make a considered purchase.',
